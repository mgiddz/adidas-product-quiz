...
2. **Adios Pro 4** — race-day shoe. ~8oz, 39mm/33mm stack (6mm drop),
...
4. **Evo SL Woven** — lighter, more affordable, plate-free sibling of Adios
   Pro. Woven mesh upper. Natural, forgiving ride at any pace; best for an
   everyday trainer that's easy on the wallet.
5. **Supernova Rise 3** — most stable/planted shoe in the lineup. Built
   around Dreamstrike+ foam (softer/plusher than Lightstrike Pro). Default
   recommendation for on-feet-all-shift customers; most budget-friendly.

Ranked lightest → heaviest (per the prototype's ordering question):
Adios Pro 4 → Evo SL Woven → Boston 13 → Hyperboost Edge → Supernova Rise 3.

Ranked by retail price, most expensive first (per prototype):
Adios Pro 4 ($250) > Hyperboost Edge ($200) > Boston 13 / Evo SL Woven.
